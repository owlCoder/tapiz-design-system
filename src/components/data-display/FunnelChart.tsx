      ...
      {steps.map((step, index) => {
        ...
        return (
          <div key={index}>
            ...
            <div className="h-9 overflow-hidden rounded-md border border-(--tapiz-border-subtle) bg-(--tapiz-bg-surface-muted)"><div className="h-full border-r border-(--tapiz-border-strong) bg-(--tapiz-accent-soft)" style={{ width: `${width}%` }} /></div>
          </div>
        );
      })}
    </div>
